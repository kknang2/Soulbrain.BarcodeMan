...
{
    [Table("SYSWebBoardFile", Schema = "QRP")]
    public class WebBoardFile : EntityAudited
    {
        //[Index("PK__SYSWebBoardFile__276FAA0A", IsClustered = true, IsUnique = true, Order = 1)]
        [Key, Column(Order = 1)]
        [Required]
        [StringLength(MaxPlantCodeLen)]
        public string PlantCode { get; set; }

        //[Index("PK__SYSWebBoardFile__276FAA0A", IsClustered = true, IsUnique = true, Order = 2)]
        [Key, Column(Order = 2)]
        [Required]
        [StringLength(MaxDocCodeLen)]
        public string DocCode { get; set; }

        //[Index("PK__SYSWebBoardFile__276FAA0A", IsClustered = true, IsUnique = true, Order = 3)]
        [Key, Column(Order = 3)]
        [Required]
