...
namespace Soulbrain.BarcodeMan.Helpers
{
    public static class CultureHelper
    {
        ...
        /// <summary>
        /// Returns a valid culture name based on "name" parameter. If "name" is not valid, it returns the default culture "ko-KR"
        /// </summary>
        /// <param name="name" />Culture's name (e.g. ko-KR)</param>
        ...
        /// <summary>
        /// Returns default culture name which is the first name decalared (e.g. ko-KR)
        /// </summary>
        /// <returns></returns>
        ...
        public static string GetNeutralCulture(string name)
        {
            ...
            return name.Split('-')[0]; // Read first part only. E.g. "en", "ko"
        }
    }
}
